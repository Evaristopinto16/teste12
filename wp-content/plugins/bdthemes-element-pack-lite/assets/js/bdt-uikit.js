...
(function (global, factory) {
    ...
    */
    ...
    function stateAPI (bdtUIkit) {
      ...
      bdtUIkit.prototype.registerObserver = function () {
    ...
    function boot (bdtUIkit) {
      ...
      function applyAttributeMutation(_ref2) {let { target, attributeName } = _ref2;
        ...
        if (name) {var _bdtUIkit$getComponent;
    ...
    var tooltip = {
      ...
      methods: {
        ...
        _show() {
          ...
          this.id + "\" class=\"bdt-" + this.$options.name + "\" role=\"tooltip\"> <div class=\"bdt-" +
